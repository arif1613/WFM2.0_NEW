...
namespace MPS.MPP.Auxiliary.ConaxWorkflowManager.Core.Util.Conax
{
    ...
    public class ConaxIntegrationHelper
    {
        ...
        internal static String GetDisplayAspectRatio(Asset asset)
        {
            ...
            Property displayAspectRatioProperty = asset.Properties.SingleOrDefault<Property>(p => p.Type.Equals("DisplayAspectRatio"));
        ...
        internal static void SetProfileUsedProperty(ContentData content, string profileName, bool trailer)
        {
            ...
            Property profileUsedProperty = content.Properties.SingleOrDefault<Property>(p => p.Type.Equals(propertyName));
            if (profileUsedProperty == null)
            {
                profileUsedProperty = new Property() { Type = propertyName, Value = profileName };
                content.Properties.Add(profileUsedProperty);
            }
            else
                profileUsedProperty.Value = profileName;
