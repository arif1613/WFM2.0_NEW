    ...
    public class Config
    {
        ...
        public static void Init(XmlDocument d)
        {
            ...
            try
            {
                ...
                {
                    TaskConfig taskCfg = new TaskConfig(module);
                ...
                */
                ...
                {
                    CustomConfig customConfig = new CustomConfig(module);
                ...
                */
                ...
                FileInfo log4NetFile = new FileInfo(Log4netConfig);
                ...
                log.Info("Started log4net successfully");
                ...
                {
                    WorkFlowConfig workFlowConfig = new WorkFlowConfig(module);
                ...
                {
                    IngestXMLConfig ingestXMLConfig = new IngestXMLConfig(module);
                ...
                {
                    ServiceConfig serviceConfig = new ServiceConfig(module);
