...
namespace MPS.MPP.Auxiliary.ConaxWorkflowManager.Core.WorkFlow.Handler
{
    public abstract class ResponsibilityHandler
    {
        ...
        public static IDBWrapper DBWrapper = DBManager.Instance;
        ...
        public RequestResult HandleRequest(RequestParameters parameters)
        {
            try
            {
                ...
                if (wp == null)
                {
                    ...
                    DBWrapper.AddWorkFlowProcess(parameters.CurrentWorkFlowProcess);
                    ...
                    else if (result.State == RequestResultState.Successful)
                    {
                        ...
                        DBWrapper.UpdateWorkFlowProcess(parameters.CurrentWorkFlowProcess);
                    }
                }
                else
                {
        ...
        protected void SaveCurrentWorkFlowProcessToDB()
        {
            DBWrapper.UpdateWorkFlowProcess(requestParameters.CurrentWorkFlowProcess);
        }
