...
namespace MPS.MPP.Auxiliary.ConaxWorkflowManager.Core.Task
{
    public class EPGIngestTask : BaseTask
    {
        ...
        private Dictionary<UInt64, List<EpgContentInfo>> GetEpgItemsFromFeeds()
        {
            ...
            EPGParser.SetExecuteTime(_executeTime);
            ...
            foreach(KeyValuePair<UInt64, List<EpgContentInfo>> kvp in contents) 
            {
                foreach (EpgContentInfo epg in kvp.Value)
                {
                    try
                    {
                        ...
                        // check type, add state proeprty if needed.
                        //var enableCatchUpProperty = content.Properties.FirstOrDefault(p => p.Type.Equals(CatchupContentProperties.EnableCatchUp));
                        //if (enableCatchUpProperty != null && Boolean.Parse(enableCatchUpProperty.Value))
                        //{
                        //    content.Properties.Add(new Property(CatchupContentProperties.CatchupHLSManifestState, ManifestState.NotAvailable.ToString("G")));
                        //    content.Properties.Add(new Property(CatchupContentProperties.CatchupSSManifestState, ManifestState.NotAvailable.ToString("G")));
                        //}
                        ...
                        {
                            //content.Properties.Add(new Property(CatchupContentProperties.NPVRHLSManifestState, ManifestState.NotAvailable.ToString("G")));
                            //content.Properties.Add(new Property(CatchupContentProperties.NPVRSSManifestState, ManifestState.NotAvailable.ToString("G")));
                            ...
                            //content.Properties.Add(new Property(CatchupContentProperties.NPVRArchiveTimes, ""));
                        

                            //content.Properties.Add(new Property(CatchupContentProperties.NPVRAllRecordingsUpdatedWithSmooth, false.ToString()));
                            //content.Properties.Add(new Property(CatchupContentProperties.NPVRAllRecordingsUpdatedWithHLS, false.ToString()));
                            //content.Properties.Add(new Property(CatchupContentProperties.NPVRAllRecordingsUpdatedWithURL, false.ToString()));

                            //content.Properties.Add(new Property(CatchupContentProperties.SSSourceSegmentState, ManifestState.Available.ToString("G")));
                            //content.Properties.Add(new Property(CatchupContentProperties.HLSSourceSegmentState, ManifestState.Available.ToString("G")));
                        }
                      ...
                      //  MPPIntegrationServicesWrapper mppWrapper = MPPIntegrationServiceManager.InstanceWithPassiveEvent;
                        ...
                        //log.Debug("Done fetching all services for content");
                        //content.ContentAgreements = agreements;
                        //log.Debug("Fetched agreements");
